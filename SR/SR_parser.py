...
def parameter_parser():
    ...
    parser.add_argument('--dataroot', type=str, default="/home/ay3/houls/watermark_dataset/derain/SrrStage/after_watermark",
                        help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
    parser.add_argument('--outnum', type=int, default=4, help="how many photos can be concated for output")
    parser.add_argument('--num', type=int, default=3, help="how many photos can be concated for input")
    ...
    # single是用于测试时的数据集
    parser.add_argument(
        '--outroot', default=f'/home/ay3/houls/Deep-Model-Watermarking/result/derain_flower_SR', help='folder to output images')
    ...
    #                     default=f'./result/derain_flower_SR/{time.strftime("%Y-%m-%d-%H_%M", time.localtime())}/checkpoints', help='models are saved here')
    parser.add_argument(
    ...
    parser.add_argument('--which_epoch', type=str, default='191',
                        help='which epoch to load H? set to latest to use latest cached model')
    ...
    parser.add_argument('--isTrain', default=True, help="is train")
